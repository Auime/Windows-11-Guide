  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative w-full h-full rounded-full bg-muted text-xs font-medium text-muted-foreground transition-all duration-300 flex items-center justify-center",
          "data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-500 data-[state=active]:to-cyan-400",
          "data-[state=completed]:bg-gradient-to-br data-[state=completed]:from-green-500 data-[state=completed]:to-emerald-400",
          "data-[state=active]:text-white data-[state=completed]:text-white",
          "data-[state=active]:scale-110 data-[state=active]:shadow-md",
          "data-[state=completed]:shadow-md",
          className,
        )}
        data-state={state}
        {...props}
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "m-0.5 bg-muted transition-all duration-300",
          "group-data-[orientation=horizontal]/stepper:h-0.5 group-data-[orientation=vertical]/stepper:h-12",
          "group-data-[orientation=horizontal]/stepper:w-full group-data-[orientation=vertical]/stepper:w-0.5",
          "group-data-[orientation=horizontal]/stepper:flex-1",
          "group-data-[state=completed]/step:bg-gradient-to-r group-data-[state=completed]/step:from-green-500 group-data-[state=completed]/step:to-emerald-400",
          className,
        )}
        {...props}
      />
